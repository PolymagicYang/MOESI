...
// Updates the internal statistic counters for given Manager
...
void stats_memory_access(uint32_t, int);
...
// Global value giving the number of Manager's in the simulation
